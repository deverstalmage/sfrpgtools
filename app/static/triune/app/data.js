export const CORE_RULEBOOK = 'Core Rulebook';
export const CORE_RULEBOOK_LEGACY = 'Core Rulebook Legacy';
export const ALIEN_ARCHIVE = 'Alien Archive';
export const PACT_WORLDS = 'Pact Worlds';
...
export const races = ['Android', 'Human', 'Kasatha', 'Lashunta', 'Shirren', 'Vesk', 'Ysoki'];
export const legacyRaces = ['Dwarf', 'Elf', 'Gnome', 'Half-Elf', 'Half-Orc', 'Halfling'];
export const aaRaces = ['Barathu', 'Contemplative', 'Draelik', 'Dragonkin', 'Drow', 'Formian', 'Space Goblin', 'Gray', 'Haan', 'Ikeshti', 'Kalo', 'Maraquoi', 'Nuar', 'Reptoid', 'Rhyporian', 'Sarcesian', 'Shobhad', 'Skittermander', 'Urog', 'Verthani', 'Witchwyrd', 'Wrikreechee'];
export const pwRaces = ['Astrazoan', 'Bantrid', 'Borai', 'Khizar', 'SRO', 'Strix'];
export const ages = ['Child', 'Young', 'Adult', 'Mature', 'Old'];
export const classes = ['Envoy', 'Mechanic', 'Mystic', 'Operative', 'Solarian', 'Soldier', 'Technomancer'];
...
export const themes = ['Ace Pilot', 'Bounty Hunter', 'Icon', 'Mercenary', 'Outlaw', 'Priest', 'Scholar', 'Spacefarer', 'Xenoseeker'];
export const pwThemes = ['Solar Disciple', 'Roboticist', 'Wild Warden', 'Corporate Agent', 'Gladiator', 'Cyberborn', 'Tempered Pilgrim', 'Space Pirate', 'Death-Touched', 'Dragonblood', 'Dream Prophet', 'Biotechnician', 'Xenoarchaeologist', 'Cultist'];
export const professions = ['Accountant', 'Actor', 'Archaeologist', 'Architect', 'Artist', 'Builder', 'Bounty Hunter', 'Comedian', 'Con Artist',
  ...
  'Vidgamer', 'Writer'];
export const personalities = ['Accusative', 'Active', 'Adventurous', 'Affable', 'Aggressive',
...
export const settlementQualities = {
...
export const CITY_SIZE_EMPTY = 'empty';
export const CITY_SIZE_TINY = 'tiny';
export const CITY_SIZE_SMALL = 'small';
export const CITY_SIZE_MEDIUM = 'medium';
export const CITY_SIZE_LARGE = 'large';
export const CITY_SIZE_HUGE = 'huge';

export const citiesBySize = {
  [CITY_SIZE_EMPTY]: [
    "lost city",
    "ruined city",
...
export const settlementFlavors = [
